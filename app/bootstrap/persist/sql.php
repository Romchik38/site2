...
return function (Container $container) {
    ...
    $container->multi(
        '\Romchik38\Site2\Infrastructure\Persist\Sql\ReadModels\Article\AdminMostVisited\Repository',
        '\Romchik38\Site2\Application\Article\AdminMostVisited\RepositoryInterface',
        true,
        [
            new Promise('\Romchik38\Server\Persist\Sql\DatabaseSqlInterface'),
        ]
    ...
    $container->multi(
        '\Romchik38\Site2\Infrastructure\Persist\Sql\Banner\Repository',
        '\Romchik38\Site2\Application\Banner\BannerService\RepositoryInterface',
        true,
        [
            new Promise('\Romchik38\Server\Persist\Sql\DatabaseSqlInterface'),
        ]
    ...
    // BANNER VIEW
    $container->multi(
        '\Romchik38\Site2\Infrastructure\Persist\Sql\ReadModels\Banner\List\Repository',
        '\Romchik38\Site2\Application\Banner\List\RepositoryInterface',
        true,
        [
            new Promise('\Romchik38\Server\Persist\Sql\DatabaseSqlInterface'),
        ]
    ...
    $container->multi(
        ...
        '\Romchik38\Site2\Application\Category\List\RepositoryInterface',
        true,
        [
            new Promise('\Romchik38\Server\Persist\Sql\DatabaseSqlInterface')
        ]
    ...
    $container->multi(
        ...
        '\Romchik38\Site2\Application\Page\AdminList\RepositoryInterface',
        true,
        [
            new Promise('\Romchik38\Server\Persist\Sql\DatabaseSqlInterface')
        ]
