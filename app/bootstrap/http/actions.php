...
return function (Container $container) {
    ...
    // AttorneyLicense
    $container->shared(
        '\Romchik38\Site2\Infrastructure\Http\Actions\GET\AttorneyLicense\DefaultAction',
        [
            new Promise('\Romchik38\Server\Http\Routers\Handlers\DynamicRoot\DynamicRootInterface'),
            new Promise('\Romchik38\Server\Utils\Translate\TranslateInterface'),
            new Promise('frontend-view'),
    ...
    // CommercialOffer
    $container->shared(
        '\Romchik38\Site2\Infrastructure\Http\Actions\GET\CommercialOffer\DefaultAction',
        [
            new Promise('\Romchik38\Server\Http\Routers\Handlers\DynamicRoot\DynamicRootInterface'),
            new Promise('\Romchik38\Server\Utils\Translate\TranslateInterface'),
            new Promise('frontend-view'),
    ...
    // Contacts
    $container->shared(
        '\Romchik38\Site2\Infrastructure\Http\Actions\GET\Contacts\DefaultAction',
        [
            new Promise('\Romchik38\Server\Http\Routers\Handlers\DynamicRoot\DynamicRootInterface'),
            new Promise('\Romchik38\Server\Utils\Translate\TranslateInterface'),
            new Promise('frontend-view'),
