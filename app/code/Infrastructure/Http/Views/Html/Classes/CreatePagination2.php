 ...
 * */
final class CreatePagination2 implements CreatePaginationInterface
{
    ...
    public function __construct(
        ...
        private readonly Pagination2 $pagination,
        ...
        if ($pagination->limit === 0) {
            $this->limit = $pagination->totalCount;
        } elseif ($pagination->limit > 0) {
            $this->limit = $pagination->limit;
        } else {
            throw new InvalidArgumentException(sprintf(
                'Param limit %s is invalid',
    ...
    {
        $queryArr = [
            $this->pagination->pageFieldName  => $part,
            $this->pagination->limitFieldName => (string) $this->pagination->limit,
        ];
        foreach ($this->pagination->getQueries() as $query) {
            $queryArr[$query->key] = (string) $query->value;
        }
