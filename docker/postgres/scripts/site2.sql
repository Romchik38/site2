...
rights-of-a-person-held-administratively-liable	t	1	113	69	2025-07-02 14:41:54	2025-07-03 16:55:03	12
...
12	en	Training	Our law firm offers practical lectures for lawyers covering current topics, real cases, and document work. Lectures last 2–3 hours and provide maximum benefit. Fast, professional, and focused on results and practical skills.	<p>2</p>
12	uk	Навчання	Наша юридична компанія проводить практичні лекції для юристів: актуальні теми, реальні кейси, робота з документами. Лекції тривають 2–3 години та дають максимум користі. Швидко, професійно, з фокусом на результат і практику.	<p>4</p>
\.
...
SELECT pg_catalog.setval('public.page_id_seq', 12, true);
