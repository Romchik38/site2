...
rights-of-a-person-held-administratively-liable	t	1	113	69	2025-07-02 14:41:54	2025-07-03 16:55:03	14
...
14	en	Special offers	Take advantage of our law firm’s special offers: free initial consultation, discounts for new clients, and fixed-price service packages. Professional legal help has never been more accessible. Don’t miss this opportunity!	<p>2</p>
14	uk	Спеціальні пропозиції	Скористайтесь спеціальними пропозиціями від нашої юридичної компанії: безкоштовна первинна консультація, знижки для нових клієнтів, пакетні послуги за фіксованою ціною. Професійна допомога стала ще доступнішою. Не втрачайте можливість!	<p>3</p>
...
SELECT pg_catalog.setval('public.page_id_seq', 14, true);
