...
SELECT pg_catalog.setval('public.audio_identifier_seq', 43, true);
...
SELECT pg_catalog.setval('public.author_identifier_seq', 17, true);
...
SELECT pg_catalog.setval('public.img_identifier_seq', 85, true);
